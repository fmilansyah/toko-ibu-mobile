        ...
        {loading ? (
          ...
          <View style={globalStyle.paddingHorizontal}>
            ...
            <View style={OrderListStyle.labelColumn}>
              ...
              <View>
                <Text style={OrderListStyle.valueText}>{order?.nama_user}</Text>
              </View>
            </View>
            <View style={OrderListStyle.labelColumn}>
              <View>
                    ...
                    <View>
                      ...
                      <View style={OrderListStyle.productPriceContainer}>
                        <Text style={OrderListStyle.productPrice}>
                          {item?.jumlah_barang}x {rupiahFormatter(item?.harga)}
                        </Text>
                      </View>
                    </View>
                  </View>
            ...
            <View style={OrderListStyle.sectionContainerDetail}>
              ...
              <View style={OrderListStyle.labelColumn}>
                <View>
                  <Text style={OrderListStyle.labelText}>No. Tlp Pembeli</Text>
                </View>
                <View>
                  <Text style={OrderListStyle.valueText}>
                    {order?.no_telepon ?? '-'}
            ...
            <View style={OrderListStyle.sectionContainerDetail}>
              ...
              <View style={OrderListStyle.labelColumn}>
                <View>
                  <Text style={OrderListStyle.valueText}>Total Pembelian</Text>
                </View>
                <View>
                  <Text style={OrderListStyle.valueText}>
            ...
            <View>
              {order?.status_order === STATUS_ORDER.DELIVERY && (
                <TouchableOpacity
                  ...
                  <Text style={globalStyle.submitBtnText}>Pesanan Selesai</Text>
                </TouchableOpacity>
              )}
